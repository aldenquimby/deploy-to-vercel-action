## 🍴 Fork Background
- Forks [BetaHuhn/deploy-to-vercel-action](https://github.com/BetaHuhn/deploy-to-vercel-action) because that repo was abandoned in 2024
- All `2.x` releases represent net new features

<div align="center">

# Deploy to Vercel Action

[![Node CI](https://github.com/aldenquimby/deploy-to-vercel-action/workflows/Node%20CI/badge.svg)](https://github.com/aldenquimby/deploy-to-vercel-action/actions?query=workflow%3A%22Node+CI%22) [![Release CI](https://github.com/aldenquimby/deploy-to-vercel-action/workflows/Release%20CI/badge.svg)](https://github.com/aldenquimby/deploy-to-vercel-action/actions?query=workflow%3A%22Release+CI%22) [![GitHub](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/aldenquimby/deploy-to-vercel-action/blob/master/LICENSE) ![David](https://img.shields.io/david/betahuhn/deploy-to-vercel-action)
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to Vercel Action
        uses: aldenquimby/deploy-to-vercel-action@v2
        with:
...
```yml
uses: aldenquimby/deploy-to-vercel-action@latest
```
...
Here are all the inputs [deploy-to-vercel-action](https://github.com/aldenquimby/deploy-to-vercel-action) takes:
...
If you want, [deploy-to-vercel-action](https://github.com/aldenquimby/deploy-to-vercel-action) can assign multiple domains to each deployment and also change the PR preview domain:
...
If you have an idea for another use case, [create a discussion](https://github.com/aldenquimby/deploy-to-vercel-action/discussions/new?category=show-and-tell) and maybe I will add it here!
...
- run `yarn build` or `npm run build` to produce a production version of [deploy-to-vercel-action](https://github.com/aldenquimby/deploy-to-vercel-action) in the `dist` folder.
...
**[deploy-to-vercel-action](https://github.com/aldenquimby/deploy-to-vercel-action) is in no way affiliated with Vercel.**
